...
const RestaurantprofileDetails = ({ res, onDelete }) => {
    ...
    return (
        <div className="RestaurantDetails">
            ...
            <p><strong>Restaurant License Number :</strong>{res.Restaurant_license_number}</p>
            <p><strong>Restaurant Name :</strong>{res.Restaurant_name}</p>
            <p><strong>Restaurant Manager's Name :</strong>{res.Restaurant_Manager_name}</p>
            ...
            <p><strong>Confirm Password :</strong>{res.Confirm_password}</p>
